...
- `.unit/` 는 species/hero catalog, class/package catalog, workflow canon, mission site project data 를 소유하지 않는다.
...
- species, hero, class, workflow, party 정본 정의
...
- catalog 와 mission site 를 분리해야 species/class/workflow/party 재사용성과 운영 경계가 유지된다.
...
- 이 저장소에는 실제 운영 unit 인스턴스 대신 template 수준 파일만 둔다.
