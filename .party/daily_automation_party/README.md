...
6. Let night-watch and exception reports use the updated activity/ledger
...
Inspect the next scheduled metadata-only collector runs, then use the receipt
and review register to decide whether the local default should be copied to
another always-on node.
