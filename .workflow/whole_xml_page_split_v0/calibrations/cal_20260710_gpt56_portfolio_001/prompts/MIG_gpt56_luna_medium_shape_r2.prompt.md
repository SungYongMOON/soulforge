...
Emit the exact public workflow output groups as top-level fields: page_xml_assets, page_manifest, page_index, source_provenance, page_role_hints, split_readiness.
