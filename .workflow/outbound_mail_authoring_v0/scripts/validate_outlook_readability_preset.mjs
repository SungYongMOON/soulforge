...
if (presetTables?.width_mode !== expectedTables.width_mode || presetTables?.default_width_pt !== expectedTables.default_width_pt || presetTables?.maximum_width_pt !== expectedTables.maximum_width_pt || presetTables?.horizontal_alignment !== expectedTables.horizontal_alignment || presetTables?.auto_fit_to_window !== expectedTables.auto_fit_to_window || presetTables?.wrap_cell_text !== expectedTables.wrap_cell_text || presetTables?.column_sizing !== expectedTables.column_sizing) fail("preset table layout mismatch");
