...
Emit the exact public workflow output groups as top-level fields: inventory_report, conversion_plan, old_new_packet_manifest, dbdoctor_execution_logs, conversion_receipt, boundary_review_note.
