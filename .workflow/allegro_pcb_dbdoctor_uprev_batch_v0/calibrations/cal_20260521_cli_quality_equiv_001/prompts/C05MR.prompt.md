...
Species: dwarf
Class: auditor
Role: shape_clarified_mini_finalist_rerun
...
- The workflow_output_packet object must include these required sections using these exact key names: bound_runtime_scope, path_policy_report, inventory_report, conversion_plan, old_new_packet_manifest, dbdoctor_execution_logs, conversion_result_matrix, conversion_receipt, boundary_review_note.
