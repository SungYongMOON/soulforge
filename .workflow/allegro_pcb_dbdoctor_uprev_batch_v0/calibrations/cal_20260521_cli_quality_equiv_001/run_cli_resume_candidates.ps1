...
$Profiles = @(
  @{ id = "C05M"; model = "gpt-5.4-mini"; effort = "medium"; species = "dwarf"; class = "auditor"; role = "mini_medium_retry_after_xhigh_runtime_stall" },
  @{ id = "C06"; model = "gpt-5.4"; effort = "medium"; species = "human"; class = "auditor"; role = "species_shadow_human_auditor" },
  @{ id = "C07"; model = "gpt-5.4"; effort = "medium"; species = "dwarf"; class = "administrator"; role = "class_shadow_administrator" },
  @{ id = "C08"; model = "gpt-5.4"; effort = "medium"; species = "dwarf"; class = "archivist"; role = "class_shadow_archivist" }
)
...
"@
  ...
  [System.IO.File]::AppendAllText((Join-Path $Archive "cli_run_manifest.resume.jsonl"), (($ResumeRow | ConvertTo-Json -Compress -Depth 8) + "`n"), $Utf8NoBom)
