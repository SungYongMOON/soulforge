...
- [`owner_decision_packet_v0/workflow.yaml`](owner_decision_packet_v0/workflow.yaml): draft workflow skeleton for recording scoped owner decisions and downstream effects so later workflows can consume a consistent decision packet without confusing it with source truth.
