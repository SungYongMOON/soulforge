You are calibrating the Soulforge workflow "se_knowledge_wiki_pipeline_v0".
...
Required JSON shape:
{
  ...
  "candidate_label": "gpt-5.5|medium|dwarf|pathfinder",
  "profile": { "model": "gpt-5.5", "reasoning_effort": "medium", "species": "dwarf", "class": "pathfinder" },
  "outputs": {
