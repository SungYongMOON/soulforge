...
Emit the exact public workflow output groups as top-level fields: quality_review_scope_binding, source_text_index_inventory, traceability_sidecar_inventory, answer_run_trace_inventory, page_quality_review_packet, boundary_review_note.
