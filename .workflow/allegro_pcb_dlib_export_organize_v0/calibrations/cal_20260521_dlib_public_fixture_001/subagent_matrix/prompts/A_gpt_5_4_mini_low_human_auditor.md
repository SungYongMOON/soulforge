...
Candidate id: A_gpt_5_4_mini_low_human_auditor
Profile: model=gpt-5.4-mini reasoning_effort=low species=human class=auditor.
Profile posture: species $Species means adaptable baseline for disciplined frontline, evidence, and coordination units; class $Class means verification-first structural checks, acceptance gates, and release-readiness review.
