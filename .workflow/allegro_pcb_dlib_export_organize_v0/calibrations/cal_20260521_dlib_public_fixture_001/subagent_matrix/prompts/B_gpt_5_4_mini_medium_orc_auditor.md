...
Candidate id: B_gpt_5_4_mini_medium_orc_auditor
Profile: model=gpt-5.4-mini reasoning_effort=medium species=orc class=auditor.
Profile posture: species $Species means forceful advance, stubborn follow-through, and field coordination; class $Class means verification-first structural checks, acceptance gates, and release-readiness review.
