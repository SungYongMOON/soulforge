...
Candidate id: A_gpt_5_4_mini_low_human_administrator
Profile: model=gpt-5.4-mini reasoning_effort=low species=human class=administrator.
Profile posture: species $Species means adaptable baseline for disciplined frontline, evidence, and coordination units; class $Class means governance-first review gates, boundary control, delegation, and promotion handoff.
...
- Output only one valid JSON object. No markdown fences, no prose outside JSON.
