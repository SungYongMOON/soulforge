...
Candidate id: A_gpt_5_4_mini_low_darkelf_archivist
Profile: model=gpt-5.4-mini reasoning_effort=low species=darkelf class=archivist.
Profile posture: species $Species means hidden-path reading, oblique entry, and shadow-side risk tracing; class $Class means evidence-first source inspection, relation stitching, and careful drafting.
