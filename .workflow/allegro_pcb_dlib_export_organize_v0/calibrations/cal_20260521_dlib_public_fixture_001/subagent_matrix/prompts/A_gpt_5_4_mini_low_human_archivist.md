...
Candidate id: A_gpt_5_4_mini_low_human_archivist
Profile: model=gpt-5.4-mini reasoning_effort=low species=human class=archivist.
Profile posture: species $Species means adaptable baseline for disciplined frontline, evidence, and coordination units; class $Class means evidence-first source inspection, relation stitching, and careful drafting.
