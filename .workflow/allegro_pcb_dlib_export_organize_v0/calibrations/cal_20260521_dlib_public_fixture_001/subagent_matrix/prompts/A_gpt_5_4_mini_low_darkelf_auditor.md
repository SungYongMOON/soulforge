...
Candidate id: A_gpt_5_4_mini_low_darkelf_auditor
Profile: model=gpt-5.4-mini reasoning_effort=low species=darkelf class=auditor.
Profile posture: species $Species means hidden-path reading, oblique entry, and shadow-side risk tracing; class $Class means verification-first structural checks, acceptance gates, and release-readiness review.
