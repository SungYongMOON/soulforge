...
Candidate id: A_gpt_5_4_mini_low_elf_administrator
Profile: model=gpt-5.4-mini reasoning_effort=low species=elf class=administrator.
Profile posture: species $Species means perceptive long-view inspection, careful routing, and refined coordination; class $Class means governance-first review gates, boundary control, delegation, and promotion handoff.
