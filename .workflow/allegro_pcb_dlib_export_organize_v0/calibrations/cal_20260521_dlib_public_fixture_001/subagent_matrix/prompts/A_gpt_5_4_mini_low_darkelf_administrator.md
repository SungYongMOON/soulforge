...
Candidate id: A_gpt_5_4_mini_low_darkelf_administrator
Profile: model=gpt-5.4-mini reasoning_effort=low species=darkelf class=administrator.
Profile posture: species $Species means hidden-path reading, oblique entry, and shadow-side risk tracing; class $Class means governance-first review gates, boundary control, delegation, and promotion handoff.
