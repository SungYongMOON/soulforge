...
Emit the exact public workflow output groups as top-level fields: accepted_verification_result_packet, result_summary, accepted_result_rows, blocked_or_inconclusive_rows, acceptance_provenance, boundary_review_note.
