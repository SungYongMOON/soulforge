...
- Stable
- 현재 정본 문서는 `AGENT_CLASS_MODEL.md`, `CLASS_LOADOUT_MODEL.md`, `CLASS_PROFILE_MODEL.md`, `CLASS_VALIDATION_RULES.md`, `CLASS_METADATA_CONTRACT.md`, `INSTALLATION_AND_LOADOUT_CONCEPT.md`, `MODULE_REFERENCE_CONTRACT.md`, `DEVELOPER_INSTRUCTION_TIPS.md`, `CODEX_APP_SERVER_MULTI_AGENT_GUIDE.md` 다.
