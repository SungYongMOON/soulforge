...
export function adaptEngineeringEngineTopology(exactSourceBytes) {
  ...
  // 199/656. Pinned to the canonical recursive multi-domain topology across core/,
  ...
  // engines/configuration_change_impact/, and engines/pcb_compliance/. Legacy flat compatibility
  ...
  assertExpectedCounts(topology.modules, topology.module_edges, 199, 656, "engineering_engine_topology_source");
