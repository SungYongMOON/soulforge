...
export function adaptWatchtowerTopology(topology, exactSourceBytes) {
  ...
  assertExpectedCounts(topology.nodes, topology.edges, 27, 32, "watchtower_topology_source");
...
export function adaptEngineeringEngineTopology(exactSourceBytes) {
  ...
  assertExpectedCounts(topology.modules, topology.module_edges, 25, 105, "engineering_engine_topology_source");
