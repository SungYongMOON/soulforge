...
export function adaptEngineeringEngineTopology(exactSourceBytes) {
  ...
  // 255/855. Pinned to the canonical recursive multi-domain topology across core/,
  ...
  assertExpectedCounts(topology.modules, topology.module_edges, 255, 855, "engineering_engine_topology_source");
