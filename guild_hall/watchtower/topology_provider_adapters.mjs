...
export function adaptEngineeringEngineTopology(exactSourceBytes) {
  ...
  // 192/629. Pinned to the canonical recursive multi-domain topology across core/,
  ...
  assertExpectedCounts(topology.modules, topology.module_edges, 192, 629, "engineering_engine_topology_source");
