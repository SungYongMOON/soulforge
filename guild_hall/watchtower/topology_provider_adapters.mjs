...
export function adaptWatchtowerTopology(topology, exactSourceBytes) {
  ...
  assertExpectedCounts(topology.nodes, topology.edges, 38, 48, "watchtower_topology_source");
...
export function adaptEngineeringEngineTopology(exactSourceBytes) {
  ...
  // 254/852. Pinned to the canonical recursive multi-domain topology across core/,
  ...
  // engines/configuration_change_impact/, engines/manufacturing_readiness/,
  // engines/field_failure_corrective_action/, engines/safety_hazard/,
  // engines/bom_supply_chain_risk/, engines/interface_consistency/,
  ...
  assertExpectedCounts(topology.modules, topology.module_edges, 254, 852, "engineering_engine_topology_source");
