...
export function adaptEngineeringEngineTopology(exactSourceBytes) {
  ...
  // 244/826. Pinned to the canonical recursive multi-domain topology across core/,
  ...
  // engines/bom_supply_chain_risk/, and engines/pcb_compliance/. Legacy flat compatibility
  ...
  assertExpectedCounts(topology.modules, topology.module_edges, 244, 826, "engineering_engine_topology_source");
