...
const STEPS_BY_MODE = {
  validate: [
    ...
    ["task-hierarchy-contract", "npm run validate:task-hierarchy-contract"],
    ["task-hierarchy-mapper", "npm run validate:task-hierarchy-mapper"],
    ["workbench-intake", "npm run validate:workbench-intake"],
    ["workbench-wiring", "npm run validate:workbench-wiring"],
    ["forge-world", "npm run validate:forge-world"],
    ["deployment-pack", "npm run validate:deployment-pack"],
    ["source-lane", "npm run validate:source-lane"],
    ["module-operability", "npm run validate:module-operability"],
    ...
    ["project-document-pdf-profile", "npm run validate:project-document-pdf-profile"],
    ["context-engine", "npm run validate:context-engine"],
    ["knowledge-layer", "npm run validate:knowledge-layer"],
    ["night-chain", "npm run validate:night-chain"],
    ["context-original-read", "npm run validate:context-original-read"],
    ["context-document-preparation", "npm run validate:context-document-preparation"],
    ["context-docx-preparation", "npm run validate:context-docx-preparation"],
    ...
    ["workspace-ledgers", "npm run validate:workspace-ledgers"],
