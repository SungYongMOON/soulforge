...
- 남은 blocker는 private binding bytes/sole writer, `pathref:recovery.physical_spine_canary`의 writer-exclusive ACL·empty-root/readback, write-guard enforcement binding, registry actual binding, 4192 overlay wiring이다.
