...
export function seedRows() {
  return [
    ...
    canonRow("workspaces", {
      ...
      owner_refs: {
        logical: "docs.workspace.project_model",
        byte: HOLD_OWNER,
        revision: HOLD_OWNER,
        acceptance: HOLD_OWNER,
        backup_restore: HOLD_OWNER,
      ...
      sole_writer_ref: "hold:od-10.erp_workspace_promoter",
      current_state: "reference_in_place",
    }),
    row({
      logical_path_id: "workroot.bot_execution",
      row_kind: "work_root",
      product_refs: ["product.agent"],
      portfolio_refs: ["sf-p04"],
      ...
      module_owner_ref: "docs.program.plan06",
      owner_refs: {
        logical: "docs.program.plan06",
        byte: HOLD_OWNER,
        revision: HOLD_OWNER,
        acceptance: HOLD_OWNER,
        backup_restore: HOLD_OWNER,
      ...
      sensitivity: "protected",
      write_policy: "sole_writer",
      sole_writer_ref: "hold:od-10.bot_worktree_writer",
