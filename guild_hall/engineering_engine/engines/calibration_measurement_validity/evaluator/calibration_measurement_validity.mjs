...
export const CMV_ERROR_CODES = Object.freeze({
  ...
  AUTHORITY_REFUSED: 'CMV_AUTHORITY_REFUSED',
});
...
function validateInput(input) {
  ...
  const knownAt = parseInstant(evaluationContext.known_at, 'evaluation_context.known_at');
  if (knownAt < testedAt) {
    refuse(CMV_ERROR_CODES.TIME_INVALID, 'evaluation_context.known_at must not precede evaluation_context.tested_at');
  }
