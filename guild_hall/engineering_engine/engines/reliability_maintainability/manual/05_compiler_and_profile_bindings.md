...
per-rule provenance entry. Prototype-sensitive keys, accessors, proxies, unsafe paths, secret
sentinels, duplicate IDs, unknown tokens, and unsupported operations fail closed.
