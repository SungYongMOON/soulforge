...
- [Evaluator Adapter](evaluator/reliability_maintainability_evaluator_adapter.mjs) and
  [evaluator](evaluator/reliability_maintainability.mjs) — exact base rules only; derived
  Profile rules remain `HOLD` until separately reviewed.
...
node --test guild_hall/engineering_engine/engines/reliability_maintainability/tests/reliability_maintainability.test.mjs guild_hall/engineering_engine/engines/reliability_maintainability/tests/reliability_maintainability_compiler.test.mjs
```
