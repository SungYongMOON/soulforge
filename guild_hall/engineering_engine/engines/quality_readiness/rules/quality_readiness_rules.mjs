...
export const QUALITY_READINESS_ARTIFACT_TOKENS = Object.freeze([
  'delivery_acceptance_record',
  'manufacturing_process_flow',
]);

export function isQualityReadinessArtifactToken(token) {
  return typeof token === 'string' && QUALITY_READINESS_ARTIFACT_TOKENS.includes(token);
}
