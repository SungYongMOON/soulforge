...
import { assertTwoSourceAuthorityInvariant } from '../../../core/validators/authority.mjs';
import { RANKING_KEYS, assertNoForbiddenIdentifier, selectCapsule } from '../../../core/validators/capsule.mjs';
