...
test('the modules and everything they import read no file, clock, network, or model', () => {
  ...
  const ENTRIES = [
    '../observation/artifact_observation_candidates.mjs',
    '../observation/observation_confirmation_sheet.mjs',
    '../observation/artifact_observations_from_confirmed.mjs',
    '../observation/observation_housekeeping.mjs',
  ];
