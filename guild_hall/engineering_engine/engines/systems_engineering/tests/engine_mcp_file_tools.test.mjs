...
} from '../mcp/link_issuer.mjs';
import { resolveAccessView, validateAccessTable } from '../mcp/access_table.mjs';
import {
...
} from '../mcp/engine_context.mjs';
import { ENGINE_MCP_TOOLS_BY_NAME, TOOL_DESCRIPTORS } from '../mcp/tools/index.mjs';
...
test('a team role is shown its own answer with the paths taken out', async () => {
  ...
  try {
    ...
    const { redactFields } = await import('../mcp/access_table.mjs');
