...
- typed facts schema: `soulforge.material_procurement_readiness.typed_project_facts.v0`
...
5. Keep all live ERP retrieval, storage, writer, purchase action, supplier communication,
