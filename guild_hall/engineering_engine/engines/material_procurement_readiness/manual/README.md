...
Status: `source_supported` candidate. This package evaluates injected, pinned ERP-owned facts;
it is not a procurement, inventory, planning, supplier-management, acceptance, or
schedule-control system.

Read the shared package map first: [../README.md](../README.md).
...
5. [Compiler and evaluator](05_compiler_evaluator.md)
