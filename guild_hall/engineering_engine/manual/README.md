...
- [E01 품질 준비도](quality_readiness/README.md) — 공통 섀시를 복제하지 않고 같은 12장
  순서로 품질 규칙·권한·근거·실행 경계의 차이만 기록한다. 현재 상태는 public-synthetic
  implementation candidate이며 실과제 적용·품질 수락·release는 `HOLD`다.
