...
} from './pilot_packet_generator.mjs';
import { compileStageRules, mintEnginePolicyRef } from './stage_rule_compiler.mjs';
...
const MODULE_URL = new URL('./pilot_packet_generator.mjs', import.meta.url);
