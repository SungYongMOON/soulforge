...
import { exactRefIdentityKey } from '../kernel/identity.mjs';
...
const SUBJECT_URL = new URL('../subjects/ax_se_project_context_pilot.mjs', import.meta.url);
...
test('the pure composition has no execution adapter and preserves predecessor subject and runner bytes', () => {
  ...
  assert.equal(
    digest(new URL('../subjects/ax_se_project_role_bound_assessment.mjs', import.meta.url)),
    'a42c6bdf96b48840b100cc2464afc1d057b9ee2ae851742858e20c8de52ebe50',
  );
  assert.equal(
    digest(new URL('../tools/ax_se_project_role_bound_assessment_runner.mjs', import.meta.url)),
    'a6a67d6202d9b5641ca668d8650fbf1fafc7a604accbc4696a14a25d94a871ba',
  );
  assert.equal(
