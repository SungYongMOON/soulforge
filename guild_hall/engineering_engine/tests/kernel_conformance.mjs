...
import { canonicalise, inspectInstant, compareCodePoints } from '../kernel/canonical.mjs';
import { classifyRef, inspectIdentifierOpacity, isPlaceholder, PLACEHOLDERS } from '../kernel/identity.mjs';
import { deterministicReplayFingerprint, projectFingerprintInput, splitProvenance } from '../kernel/fingerprint.mjs';
import { ContractError } from '../kernel/errors.mjs';
import { TIME_PRECISION, OPEN_OWNER_DECISIONS, ARRAY_ORDER_RULES } from '../kernel/contract_config.mjs';
import {
...
} from '../kernel/ceilings.mjs';
import { foldCurrentView, routeDisposition, assertChainStep } from '../kernel/finding.mjs';
import { evaluate, classifyLegacyMaterial, advisoryFieldsAbsent, VERDICT, BASELINE_PHASE } from '../kernel/execution_mode.mjs';
import { NON_CAPABILITIES } from '../kernel/index.mjs';
