...
export function createBoardUsageSnapshot(events, {
  ...
  return normalizeBoardUsageSnapshot(output);
}
...
function normalizeBoardUsageSnapshot(snapshot) {
...
export async function loadBoardUsageSnapshot(stateRoot, { generatedAt } = {}) {
  ...
  return createBoardUsageSnapshot(events, {
    coverage,
    hookHealth,
    pendingEventCount,
    toolEvents,
...
export async function writeBoardUsageSnapshot(outputPath, snapshot) {
  const clean = normalizeBoardUsageSnapshot(snapshot);
