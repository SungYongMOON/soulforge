...
import { SEGMENT_ITEM_SEPARATOR, segmentItemId } from '../adapters/sources/voice_session_source.mjs';

export { SEGMENT_ITEM_SEPARATOR, segmentItemId, splitSegmentItemId } from '../adapters/sources/voice_session_source.mjs';
