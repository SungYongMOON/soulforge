...
import { buildProjectContextGenerationCandidate } from '../../engineering_engine/kernel/project_context_generation_candidate.mjs';

import { fixture, correctedFixture, sourceMetadata } from '../harness/fixtures/accepted_context_read_fixture.mjs';
