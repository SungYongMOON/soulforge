...
import { buildProjectContextGenerationCandidate, computeProjectContextExportedMembershipDigest, computeProjectContextExportedSourceRevisionSetDigest } from '../../engineering_engine/kernel/project_context_generation_candidate.mjs';
import {
...
} from '../src/guards/accepted_context_query.mjs';

const MODULE_URL = new URL('../src/guards/accepted_context_query.mjs', import.meta.url);
