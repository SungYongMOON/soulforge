...
- `slices/ENGINE-8-TEAM-MAIL-DEDUP.md` — 팀 메일 사본 통합(메시지ID 정확 매칭 + fingerprint 폴백) (G-intake-cycle, **unblocked 2026-07-03: K-5 owner 승인** — 원장 컬럼 2종 추가 포함, 패킷 "owner 결정 기록" 절 참조)
...
- `slices/ENGINE-4-FOLLOWUP-SLA.md` — 무응답·기한 팔로업 (G-intake-cycle, **blocked 2026-07-02: K-2 owner 기본 정책 미확정**)
