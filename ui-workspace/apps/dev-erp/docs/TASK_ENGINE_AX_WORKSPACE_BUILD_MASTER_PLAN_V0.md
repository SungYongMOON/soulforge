...
| `A8-SYNTH` | `independent_public_synthetic_side_card` | D27~D29와 exact public security child packet prerequisite acceptance 뒤 pathless/feature-OFF fixtures만 독립 실행. P1/P8/P9/TaskEngine/live binding unlock `0` |
