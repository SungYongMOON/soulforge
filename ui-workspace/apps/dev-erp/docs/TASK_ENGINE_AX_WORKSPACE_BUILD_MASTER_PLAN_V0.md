...
> 2026-08-20 CURRENT: public-synthetic foundations were integrated without activating a live
...
> persist one body-free candidate; an authentic-producer P5 Module can prepare a complete
> human-review candidate under a separate trusted request pin; and `backup_controller` has an
> offline Linear LB1 manifest/restore contract plus an exact feature-OFF Owner start Gate. Actual project PDF execution, operational
