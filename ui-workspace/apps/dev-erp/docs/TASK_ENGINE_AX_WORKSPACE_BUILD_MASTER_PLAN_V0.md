...
| --- | --- | --- |
| `C00` | exact first packet candidate | owner가 `public_only_stdout`을 고르면 public static inventory만 시작 가능. `owner_authorized_query_only`는 별도 승인 |
...
10. §12.1 slice별 minimum independent review. 공개 기준선 `main@245d210e49da403d53c4731981ace8b6e5f820c1`의
...
fresh root validation/review (공개 기준선 `main@245d210e49da403d53c4731981ace8b6e5f820c1`까지 PASS;
...
| HP-21 | 공개 `main@245d210e49da403d53c4731981ace8b6e5f820c1` plan-scope validation `PASS`; 구현 full regression 미실행 | 각 후속 문서 delta publish 전 재검증, 각 approved implementation slice는 별도 full regression |
...
`main@245d210e49da403d53c4731981ace8b6e5f820c1`까지 계획 범위 상태는 `PASS`다. 명령명이
