...
12. [`AX_WORKSPACE_TASK_ENGINE_INTEGRATED_VALIDATION_PLAN_V0.md`](AX_WORKSPACE_TASK_ENGINE_INTEGRATED_VALIDATION_PLAN_V0.md)
13. [`task_engine_redesign/README.md`](task_engine_redesign/README.md)와 불변 `01`~`10`
14. [`ENGINE-12-CONTEXT-LIFE-TREE.md`](slices/ENGINE-12-CONTEXT-LIFE-TREE.md)
15. [`ENGINE-13-TASK-DRIVER-CLOSED-LOOP.md`](slices/ENGINE-13-TASK-DRIVER-CLOSED-LOOP.md)
16. [`MASTER_PLAN_20260613.md`](MASTER_PLAN_20260613.md),
...
17. 위 문서가 직접 가리키는 current code, schema, API, test, RAG, life-tree surface
...
6. AC-01~AC-20 completeness check
