...
if errorlevel 1 (
  echo [dev-erp] refused: Tailscale backend 4300 must be started from C:\Soulforge-runtime.
  echo [dev-erp] For C:\Soulforge development use: node server.mjs --host 127.0.0.1 --port 4310
  exit /b 2
)
