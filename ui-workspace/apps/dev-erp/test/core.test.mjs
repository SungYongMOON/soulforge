...
test("codex bridge: app-server turn input can carry skill and localImage items", () => {
  const input = buildCodexTurnInput({
    ...
    skills: [{ name: "soulforge-shield-wall", path: windowsAbsolute("Users", "user", ".codex", "skills", "soulforge-shield-wall", "SKILL.md") }],
    localImages: [{ path: windowsAbsolute("Soulforge", "_workspaces", "system", "dev-erp", "codex-task-attachments", "IT-001", "shot.png") }],
  });
