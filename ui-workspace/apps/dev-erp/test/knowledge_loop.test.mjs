...
test("C: developer instructions 는 mutable task metadata와 host 포인터를 주입하지 않는다", () => {
  ...
  assert.doesNotMatch(enriched, /ERP has 2 source pointer|ERP has 2 knowledge pointer/);
  assert.doesNotMatch(enriched, /origin_mail:P26-014:abc|codex_thread:thr_1/);
  assert.doesNotMatch(enriched, /KVDS 요구사양서|p26_014_req\.md|idx_only/);
