...
<button id="refresh" type="button">새로고침</button><button id="next" type="button" disabled>이어보기</button><p id="status" role="status" aria-live="polite"></p><section id="items" aria-label="피드백 기록"></section><section id="detail" aria-label="근거 메타데이터"></section></main>
