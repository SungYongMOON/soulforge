...
test('display names require exact project identity and bounded registered store read',()=>{
 ...
 for(const value of [{project_code:'P26-002',approved_fs_key:'P26-001',project_name:'wrong'},{project_code:'P26-001',approved_fs_key:'P26-001',project_name:['C:','private','file'].join(String.fromCharCode(92))}])assert.equal(readProjectLabel({read:()=>Buffer.from(JSON.stringify(value))},'P26-001'),null);
});
