...
const ADAPTER_TABLE = Object.freeze([
  { module: "codex-quota-read.mjs", factory: "createCodexQuotaPlugin", url: "/codex-live-limits.json" },
  ...
  { module: "mail-rule-adapter.mjs", factory: "createMailRulePlugin", url: "/mail-rules.snapshot.json" },
