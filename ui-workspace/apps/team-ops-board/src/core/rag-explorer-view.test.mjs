...
test('graph scene only displays supplied DB relationships, without inventing missing edges',()=>{
  const graph=ragGraphScene({nodes:[{id:'d',labels:['Document'],name:'합성 문서'},{id:'c',labels:['Chunk'],unit:'u1'}],edges:[{id:'r',source:'c',target:'d',type:'FROM_DOCUMENT'},{id:'outside',source:'other',target:'c',type:'NEXT_CHUNK'}]});
