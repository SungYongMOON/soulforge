...
- The workflow owns the NotebookLM CLI-first Deep Research, Codex independent research, optional Gemini/GPT web Deep Research advisory lanes, comparison, and delta handoff sequence.
...
- The skill package does not own Drive upload, NotebookLM bookshelf registration, Gemini/GPT account auth, wiki promotion, source truth, owner approval, or canon promotion.
