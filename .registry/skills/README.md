...
- `project_bootstrap/` is the tracked thin launcher for starting Development Team 1 projects through `development_team1_project_bootstrap_v0`, keeping classification, identity preview, packet creation, compatibility gates, first-work canary, and review authority in the workflow.
...
- `project_bootstrap/` is the tracked Codex bridge for `$soulforge-project-bootstrap`, resolving to `development_team1_project_bootstrap_v0` without copying project identities, people, runtime paths, profile choices, integration state, or mutation authority into the skill.
