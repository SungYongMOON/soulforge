...
- When wiki/sourcebound metadata changes should refresh RAG visibility, the launcher prepares only a metadata-only handoff to `rag_metadata_refresh_v0`; it does not own source-text indexing, NotebookLM mutation, public canon promotion, or answer authority.
