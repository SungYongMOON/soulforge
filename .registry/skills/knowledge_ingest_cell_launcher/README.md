...
- It keeps copy-only preprocessing, source audit, wiki/RAG preparation, owner decision gates, metadata-only receipt/missing-audit capture, and closeout review connected while preserving `default_route_safe: false`.
