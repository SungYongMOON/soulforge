...
- The bridge preserves fresh executor/verifier separation, cumulative same-run artifact chaining for warm transformation rounds, Codex goal declaration, run evidence logging, source-packet provenance, and oracle-boundary rules.
