...
- The skill maps decision dependencies, asks the current independent frontier in numbered rounds, records owner decisions, and keeps final design authority with the owner.
- The owner can request one-at-a-time questioning when a round would create too much cognitive load.
