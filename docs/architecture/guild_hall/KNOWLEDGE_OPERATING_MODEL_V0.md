...
| --- | --- | --- |
| Google Drive | Durable source warehouse visible to approved PCs and usable as the owner-held source archive for NotebookLM. | Holds candidate or approved source files and Drive-native source refs. Folder placement, a `CANON` label, connector visibility, or a successful connector read is not approval, source truth, or canon; `_workmeta` records the applicable approval basis and use. |
...
| Company NAS | Company owner-held external originals. | Default read-only from Soulforge. NAS access does not authorize modification, automatic ingest, Drive upload, source approval, or canon promotion. |
