...
13. [`ALWAYS_ON_WORKFLOW_EVOLUTION_HARNESS_PROMPT_V0.md`](ALWAYS_ON_WORKFLOW_EVOLUTION_HARNESS_PROMPT_V0.md)
14. [`WORK_PC_BOOTSTRAP_PROMPT_V0.md`](WORK_PC_BOOTSTRAP_PROMPT_V0.md)
15. [`TOOL_PC_BOOTSTRAP_PROMPT_V0.md`](TOOL_PC_BOOTSTRAP_PROMPT_V0.md)
16. [`WORKFLOW_EVOLUTION_HARNESS_INSTALL_V0.md`](WORKFLOW_EVOLUTION_HARNESS_INSTALL_V0.md)
