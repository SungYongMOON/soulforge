...
accessible projection from approved Markdown/image metadata; persisted HTML/PDF
release artifacts, build_pack integration and user exercise evidence remain
later bounded leaves.
