...
| OD-11 | `OPEN` | Authority risk/action class taxonomy, default evidence threshold, rate limit and expiry policy | Sole-writer/enforcement/request ownership is settled; the taxonomy itself was not closed by the Fresh Grill | No generic grant/revoke schema or autonomous-action default may treat risk classes as settled |
