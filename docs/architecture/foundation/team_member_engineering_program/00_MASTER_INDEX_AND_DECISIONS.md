...
| 2026-09-01 | Product/Portfolio and external work-root reaffirmation | The Owner reaffirmed the original three-product model: ERP includes Knowledge Assets and the Context World Tree Module; Engineering Engine evaluates approved knowledge; Agent Platform owns AI execution. P01–P07 are seven core functional portfolios and P08–P09 are cross-cutting support portfolios, not additional products. Human and Bot work roots are separate physical folders outside Soulforge and outside ERP `_workspaces`; only reviewed results enter ERP canon. Exact host paths are stored in private physical-root inventory, not public canon. | Owner correction in this thread; Master Map M1/M2/M6; product rebaseline §§3/5/7/13/25; private physical-root inventory |
