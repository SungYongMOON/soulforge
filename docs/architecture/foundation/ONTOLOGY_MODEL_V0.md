...
- 사용자 업무 개체
  - `Project`, `Gate`, `Branch`, `Task`, `TaskDriver`, `Actor`
- 원본·개정 개체
...
`TaskDriver` 확장은 runtime 구현 완료가 아닌 `canon_candidate`다. exact minimum fields,
writer/approval/state/replay contract는
[`../workspace/PROJECT_TASK_ENGINE_LIFECYCLE_V0.md`](../workspace/PROJECT_TASK_ENGINE_LIFECYCLE_V0.md)가
소유한다.
