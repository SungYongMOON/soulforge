...
2026-09-09 우선순위: 기본 운영의 Buzz 지시→대기알림·답변재개→결과/보호 이력을 FP1–8로 검증한다. 작업대는 조회 중심이며 직접 실행은 첫 운영판에서 제외한다. 한글은 기존 builtin Claude·선택 스킬로 실제 사용을 우선하고 scoped/broker를 선행으로 두지 않는다. 나머지 전문 공방은 출시 후 확장한다. 첫 사용 성공은 전체 Goal 완료가 아니다.
