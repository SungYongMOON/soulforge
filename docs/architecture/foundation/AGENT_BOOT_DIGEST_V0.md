...
2026-09-08 첫 출시 우선순위: Buzz 단일 지시·대화→실제 업무1종→대기알림·답변재개·결과/보호된 원문·실제 도구 이력 조회를 FP1–8로 먼저 검증한다. 작업대 직접실행은 첫 운영판 제외, 공방/모델/화면 확장은 로드맵 유지하되 첫출시 선행조건이 아니다. 전체 Goal 완료와 구별한다.
