...
- `MEETING_PACKET_FOLDER_MODEL_V0.md`
...
- `PRIVATE_STATE_REPO_V0.md`
- `../bootstrap/BOOTSTRAP_PROFILES_V0.md`
...
- [`MEETING_PACKET_FOLDER_MODEL_V0.md`](MEETING_PACKET_FOLDER_MODEL_V0.md)
