...
- raw execution truth와 actual file inspection log는 workspace/worksite에 남기고, `_workmeta/<project_code>/runs/<run_id>/`에는 pointer, hash, status와 compact receipt만 남긴다.
