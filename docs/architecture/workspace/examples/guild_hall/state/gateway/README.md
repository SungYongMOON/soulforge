...
- mail candidate queue sample 은 [`mail_candidate/README.md`](../../../../../../../docs/architecture/workspace/examples/guild_hall/state/gateway/mail_candidate/README.md), [`mail_candidate_hiworks_hiworks_evt_2026_03_19_001.json`](../../../../../../../docs/architecture/workspace/examples/guild_hall/state/gateway/mail_candidate/queue/pending/mail_candidate_hiworks_hiworks_evt_2026_03_19_001.json), [`mail_candidate_hiworks_hiworks_evt_2026_03_19_001.mail_intake_request.json`](../../../../../../../docs/architecture/workspace/examples/guild_hall/state/gateway/mail_candidate/requests/mail_candidate_hiworks_hiworks_evt_2026_03_19_001.mail_intake_request.json) 을 본다.
...
- `intake_inbox/`
  - intake 결과 sample
- `mail_candidate/`
  - mail fetch 후 업무화 검토 후보 queue sample
- `bindings/`
...
7. mail candidate 승격 request 는 [`mail_candidate_hiworks_hiworks_evt_2026_03_19_001.mail_intake_request.json`](../../../../../../../docs/architecture/workspace/examples/guild_hall/state/gateway/mail_candidate/requests/mail_candidate_hiworks_hiworks_evt_2026_03_19_001.mail_intake_request.json) 에서 확인한다.
8. owner-facing brief 는 [`../town_crier/queue/pending/notify_pdr_brief_chain_demo_001.json`](../../../../../../../docs/architecture/workspace/examples/guild_hall/state/town_crier/queue/pending/notify_pdr_brief_chain_demo_001.json) 과 `demo_project` chain example 에서 이어서 읽는다.
