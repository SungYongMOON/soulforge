...
| --- | --- | --- |
| 저장소 루트 `./` | `README.md` | `docs/architecture/TARGET_TREE.md`, `docs/architecture/DOCUMENT_OWNERSHIP.md`, `docs/architecture/agent_body_finalization_report.md` |
...
| `docs/architecture/` | `README.md` | root-owned architecture 문서 세트 |
