...
export type RowId = "skills" | "tools" | "knowledge" | "workflows";
export type TabId = "overview" | "body" | "class" | "workspaces";
export type FixtureName = "integrated" | "overview" | "body" | "class" | "workspaces";
