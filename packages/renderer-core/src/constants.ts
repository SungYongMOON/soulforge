import type { RowId, RowPresentation, TabId, UiHintsState } from "./types";

export const TAB_ORDER: TabId[] = ["overview", "body", "class", "workspaces"];
...
export const ROW_ORDER: RowId[] = ["skills", "tools", "knowledge", "workflows"];
